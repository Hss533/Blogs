    ...
    <script type="text/javascript">
        ...
        function addBlogType(){
           //弹出框
            ...
            url="${pageContext.request.contextPath}/admin/blogType/add.do";
        }
                ...
                if(r){
                    $.post("${pageContext.request.contextPath}/admin/blogType/delete.do",{ids:ids},function(result){
                        if(result.success){
                            ...
                            $.messager.alert("系统提示","数据删除失败,请确保删除的博客类别下没有博客");
                        }
                    },"json");
                }
            });
...
<table id="dg" title="博客类别管理" class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="typeName" width="200" align="center" formatter="formatTitle">博客类别名称</th>
        <th field="orderNo" width="50" align="center">博客类别排名</th>
    </tr>
    </thead>
</table>
<div id="tb">
    <div>
        <a href="javascript:updateBlogType()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
