...
//            提交数据之前对数据要有验证
            ...
            }else if(content==null|| content=='')
            {
                ...
                $.post("${pageContext.request.contextPath}/admin/blog/save.do",{'title':title,'blogType.id':blogTypeId,'content':content,'contentNoTag':UE.getEditor('editor').getContentTxt(),'summary':UE.getEditor('editor').getContentTxt().substring(0,155),'keyWord':keyWord},
                function(result)
                {
                    if(result.success)
                    {
